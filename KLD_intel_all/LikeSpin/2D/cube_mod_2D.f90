...
CONTAINS
     ...
     END SUBROUTINE cube_input_2D

     SUBROUTINE cube_output_2D(total_int)

     IMPLICIT NONE

     DOUBLE PRECISION, INTENT(IN), DIMENSION(:,:,:) :: total_int
...
! construccion del archivo cube
     ...
     END SUBROUTINE cube_output_2D

END MODULE cube_mod_2D
